...
<h3 align="center">List of Faculties</h3>

<div align="left">
  <c:forEach items="${facultydata}" var="faculty">
    <div class="faculty-container">
      <div>
        <h3><b>ID: <c:out value="${faculty.id}" /></h3><br>
        <p><b>NAME:</b> <c:out value="${faculty.name}" /></p><br>
        <p><b>DEPARTMENT: </b><c:out value="${faculty.department}" /></p>
      </div>
      <a class="button" href='<c:url value="viewfaculty?id=${faculty.id}"></c:url>'>View</a>
    </div>
  </c:forEach>
</div>
