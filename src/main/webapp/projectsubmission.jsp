...
<body>
    ...
    <div class="container">
        ...
        <form method="post" action="#">
            ...
            <input type="text" name="name" required="required" value="${project.name}"/>
            
            <br>
            <label>Start Date</label>
            <input type="date" name="startdate" required="required" value="${project.startdate}"/>
            
            <label>End Date</label>
            <input type="date" name="enddate" required="required" value="${project.enddate}"/>
            
            <label>Project File</label>
            <br>
            <input type="file" name="projectfile" required="required"/>
             <br>
             <br>
             <br>
