...
<div align="left">
  <c:forEach items="${projectList}" var="project">
    <div class="student-container">
      <div>
        <h3><b>ID:</b> <c:out value="${project.id}" /></h3><br>
        <p><b>NAME:</b> <c:out value="${project.name}" /></p><br>
        <p><b>Description:</b> <c:out value="${project.description}" /></p><br>
      </div>
      <a class="button" href='<c:url value="projectsubmission"></c:url>'>Submit</a>
    </div>
  </c:forEach>
</div>
