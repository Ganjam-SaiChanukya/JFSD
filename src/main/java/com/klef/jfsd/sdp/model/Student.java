...
public class Student 
{
	   ...
	   @Column(name="std_department",nullable=false,length = 20)
	   private String department;
	   @Column(name="std_email",nullable=false,unique = true,length = 30)
	   private String email;
	   @Column(name="std_password",nullable=false,length = 30)
	   private String password;
	   @Column(name="std_location",nullable=false)
	   private String location;
	   @Column(name="std_contact",nullable=false,unique = true)
	...
	public String toString() {
		return "Student [id=" + id + ", name=" + name + ", gender=" + gender + ", dateofbirth=" + dateofbirth
				+ ", department=" + department + ", email=" + email + ", password=" + password + ", location="
